...
export default function RateSection(){
    const [value,setValue]=useState({sendValue:"" , base:"",quote:"" ,recie});
    useEffect(()=>{
        if(value.sendValue==""){
            Alert("PLEASE ENTER THE SEND VALUE !");
        }
        else if(value.base==""){
            Alert("PLEASE ENTER THE BASE COUNTRY VALUE !");
        }
        else if(value.quote==""){
            Alert("PLEASE ENTER THE QUOTE COUNTRY VALUE !");
        }
