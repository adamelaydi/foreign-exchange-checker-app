...
// handleClicks
import { handleDayClick ,handleWeekClick } from '../handleClicks/historyClicks';
// STYLING
...
export default function History(){
    const [state,dispatch]=useReducer(LiveMarketapiReducer,{})
    ...
    useEffect(() => {
        ...
        const option = {
            xAxis: {
                type: "category",
                boundaryGap: false,
                data:state.data?.X || ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
            },
            yAxis: {
                type: "value",
                splitLine: {
            ...
            series: [
                {
                    data:state.data?.X || [820, 932, 901, 934, 1290, 1330, 1320],
                    type: "line",
                    areaStyle: {
        ...
        <div className="history">
            <div className="header-bar">
                ...
                <Stack className='Stack' spacing={-3} direction="row">
                    <Button className='btn' variant="text" onClick={handleDayClick} >1d</Button>
                    <Button  className='btn' variant="text" onClick={handleWeekClick} >1w</Button>
