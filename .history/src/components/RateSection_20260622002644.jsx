                    ...
                    <div className="info">
                        <div className="send-sec">
                            ...
                            <div className="data">
                                ...
                                }}className="text" placeholder="00.00"/>
                                <SelectionInput
                                    value={value.base}
                                    onChange={(currency) =>
                                        setValue({
                        ...
                        <div className="receive-sec">
                            <p>receive</p>
                            <div className="data">
                                <input type="text" className="text" readOnly value={Number(value.rate*Number(value.sendValue)).toFixed(2)} placeholder="00.00"/>
                                <SelectionInput
                                    value={value.quote}
                                    onChange={(currency) =>
                                        setValue({
                        ...
                        <div className="btns">
                            <button onClick={()=>{
                                if(localStorage.getItem("favorits")==null){
                                    localStorage.setItem(JSON.stringify([{base:value.base,quote:value.quote}]))
                                }
