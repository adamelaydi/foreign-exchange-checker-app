...
export default function LogedPair({base,}){
    return(
        <div className='Loged-parent'>
            <div className="info-loged">
                <div className="name">
                    <p className="code"><span className="time">20M</span><span><span className="first">eg</span> {"->"} <span className='second'>usd</span></span></p>
                </div>
