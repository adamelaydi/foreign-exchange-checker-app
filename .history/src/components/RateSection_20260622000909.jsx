...
export default function RateSection(){
    ...
    useEffect(()=>{
        ...
        if(value.sendValue&&value.base&&value.quote &&value.rate==""){
            GetData();
        }
        console.log(value);
    },[value])
            ...
            <div className="rate">
                ...
                <div className="rate-sec">
                    ...
                    <div className="rate-footer">
                        <p>1 <span>{value.base}</span> = <span>{<span>{Number(value.rate || 0).toFixed(2)}</span>}</span> <span>{value.quote}</span></p>
                        <div className="btns">
