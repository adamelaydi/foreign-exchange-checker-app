                        ...
                        <div className="btns">
                            <button onClick={()=>{
                                if(!localStorage.getItem("favorits")){
                                    ...
                                    localStorage.setItem("favorits",JSON.stringify({JSON.parse(localStorage.getItem("localStorage.setItem("favorits",JSON.stringify([{base:value.base,quote:value.quote}]))"))}))
                                }
