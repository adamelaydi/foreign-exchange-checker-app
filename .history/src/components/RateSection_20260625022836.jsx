                        ...
                        <div className="btns">
                            <button onClick={()=>{
                                if(!localStorage.getItem("favorits")){
                                    ...
                                    localStorage.setItem("compare",JSON.stringify([{base:value.base,quote:value.quote}]))
                                }else{
                                    localStorage.setItem("favorits",JSON.stringify([...JSON.parse(localStorage.getItem("favorits")),{base:value.base,quote:value.quote}]))
                                    localStorage.setItem("favorits",JSON.stringify([...JSON.parse(localStorage.getItem("compare")),{base:value.base,quote:value.quote}]))
                                }
