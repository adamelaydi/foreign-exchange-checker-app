...
export async function GetHistory(base="USD",quote="EUR",type="1d"){
    ...
    switch (type){
        ...
        case "1m":{
            // determine the today date in sec
            // today date - (2,592,000 sec)=> month in secound
            // convert the result to this form  2026-05-01
        ...
        case "3m":{
            // determine the today date in sec
            // today date - (7,776, 000 sec)=> 3month in secound
            // convert the result to this form  2026-05-01
            url=`https://api.frankfurter.dev/v2/rates?group=month&from=${begin}`;
            break;
        }
        case "1y":{
            // determine the today date in sec
            // today date - (32,850,000 sec)=> 1year in secound
            // convert the result to this form  2026-05-01
            url=`https://api.frankfurter.dev/v2/rates?group=month&from=${begin}`;
            break;
        }
        case "5y":{
            // determine the today date in sec
            // today date - (32,850,000 sec)=> 5year in secound
            // convert the result to this form  2026-05-01
            url=`https://api.frankfurter.dev/v2/rates?group=month&from=${begin}`;
            break;
        }
